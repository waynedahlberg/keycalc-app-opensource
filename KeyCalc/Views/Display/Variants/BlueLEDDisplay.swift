      ...
      VStack(alignment: .trailing, spacing: 16) {
        ZStack(alignment: .trailing) {
          Text(baseResultText.appending(" "))
            ...
            .font(.custom("DSEG14Classic-Regular", size: largeFontSize))
...
#Preview {
  BlueLEDDisplay(largeFontSize: 44, smallFontSize: 16, resultText: "0.0", computeText: "1234*/-+56789")
}
