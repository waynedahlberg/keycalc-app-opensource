      ...
      VStack(alignment: .trailing, spacing: 16) {
        ZStack(alignment: .trailing) {
          ...
          Text(resultText.appending(" "))
            ...
            .font(.custom("DSEG7ClassicMini-BoldItalic", size: largeFontSize))
            .glow(color: .ledgreen, radius: 10, opacity: 0.6)
        }
        ...
        ZStack(alignment: .trailing) {
          ...
          Text(computeText.appending(" "))
            .foregroundStyle(.white)
            .font(.custom("DSEG14Classic-Regular", size: smallFontSize))
            .glow(color: .ledgreen, radius: 6, opacity: 0.7)
        }
        .padding(.trailing, 8)
      }
    }
...
#Preview {
  GreendLEDDisplay(largeFontSize: 44, smallFontSize: 16, resultText: "0.", computeText: "8*9-8-9")
}
